...
namespace GLXEngine.Core
{
	public class Texture2D
	{
		...
		private void CreateGLTexture ()
		{
			...
			GL.glTexParameteri (GL.GL_TEXTURE_2D, GL.GL_TEXTURE_WRAP_S, GL.GL_CLAMP_TO_EDGE_EXT);
			GL.glTexParameteri (GL.GL_TEXTURE_2D, GL.GL_TEXTURE_WRAP_T, GL.GL_CLAMP_TO_EDGE_EXT);	
		...
		public bool wrap {
			set { 
				GL.glBindTexture (GL.GL_TEXTURE_2D, _glTexture[0]);
				GL.glTexParameteri (GL.GL_TEXTURE_2D, GL.GL_TEXTURE_WRAP_S, value?GL.GL_REPEAT:GL.GL_CLAMP_TO_EDGE_EXT);
				GL.glTexParameteri (GL.GL_TEXTURE_2D, GL.GL_TEXTURE_WRAP_T, value?GL.GL_REPEAT:GL.GL_CLAMP_TO_EDGE_EXT);	
				GL.glBindTexture (GL.GL_TEXTURE_2D, 0);
				lastBound = null;
			}
		}
